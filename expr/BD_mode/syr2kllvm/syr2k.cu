...
#define PERCENT_DIFF_ERROR_THRESHOLD 0.002
...
//	cudaDeviceSetCacheConfig(cudaFuncCachePreferL1);//Du//48KB
//	cudaDeviceSetCacheConfig(cudaFuncCachePreferShared);//Du//16KB
