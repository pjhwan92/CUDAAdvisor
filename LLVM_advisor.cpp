...
namespace{
	...
	struct instru_host : public ModulePass{
		...
		virtual bool runOnModule(Module &M)
		{
			...
			Type* arr3[2] = {Type::getInt32Ty(C), NULL};
			Type* arr4[2] = {Type::getInt64Ty(C), NULL};
			Type* arrEA[3] = {Type::getInt8PtrTy(C), Type::getInt32Ty(C), NULL};
			Type* arrFCall[5] = {Type::getInt8PtrTy(C), Type::getInt8PtrTy(C), Type::getInt32Ty(C), Type::getInt32Ty(C), NULL};
			Type* arrMallocEvent[5] = {Type::getInt8PtrTy(C), Type::getInt64Ty(C), Type::getInt32Ty(C), Type::getInt32Ty(C), NULL};

			ArrayRef<Type*> arg3(arr3, 1);
			ArrayRef<Type*> arg4(arr4, 1);
			ArrayRef<Type*> argEA(arrEA, 2);
			ArrayRef<Type*> argFCall(arrFCall, 4);
			ArrayRef<Type*> argMallocEvent(arrMallocEvent, 4);

			FunctionType* type1 = FunctionType::get(VoidTy, false);
			FunctionType* type2 = FunctionType::get(VoidTy, false);
			FunctionType* type3 = FunctionType::get(VoidTy, arg3, false);
			FunctionType* type4 = FunctionType::get(VoidTy, arg4, false);
			FunctionType* typeEA = FunctionType::get(VoidTy, argEA, false);
			FunctionType* typeRetMain = FunctionType::get(VoidTy, false);
			FunctionType* typeString = FunctionType::get(VoidTy, argEA, false);
			FunctionType* typeFCall = FunctionType::get(VoidTy, argFCall, false);
			FunctionType* typeMallocEvent = FunctionType::get(VoidTy, argMallocEvent, false);

			hookFunc1 = M.getOrInsertFunction("print1", type1);
			hookFunc2 = M.getOrInsertFunction("print2", type2);
			hookFunc3 = M.getOrInsertFunction("print3", type3);
			hookFunc4 = M.getOrInsertFunction("print4", type4);
			hookFuncEA = M.getOrInsertFunction("printea", typeEA);
			hookFuncRetMain = M.getOrInsertFunction("RetMain", typeRetMain);
			hookFuncString = M.getOrInsertFunction("takeString", typeString);
			hookFuncFCall = M.getOrInsertFunction("callFunc", typeFCall);
			hookFuncMallocEvent = M.getOrInsertFunction("recordMEvent", typeMallocEvent);
		...
		virtual bool runOnBasicBlock(Function::iterator &BB)
		{
			...
			for(BasicBlock::iterator BI = BB->begin(), BE = BB->end(); BI != BE; ++BI)
			{
				...
				if ( auto *op = dyn_cast<LoadInst>( &(*BI) ) )
				{
					...
					builder.CreateCall(hookEA, {voidptr,ONE});
	...
	struct instru_kernel_memory : public ModulePass{
		...
		virtual bool runOnModule(Module &M)
		{
			...
			Constant *hookFunc1; Constant *hookFunc2;
			Constant *hookFunc3; Constant *hookFunc5;
			Constant *hookFuncString;

			Type* arr1[2] = {Type::getInt32Ty(C), NULL};
			Type* arr3[3] = {Type::getInt32Ty(C), Type::getInt32Ty(C), NULL};
			Type* arr5[7] = {Type::getInt8PtrTy(C), Type::getInt32Ty(C), Type::getInt32Ty(C), Type::getInt32Ty(C), Type::getInt32Ty(C), Type::getInt8PtrTy(C), NULL};
			//Type* arr5[8] = {Type::getInt32Ty(C), Type::getInt8PtrTy(C), Type::getInt32Ty(C), Type::getInt32Ty(C), Type::getInt32Ty(C), Type::getInt32Ty(C), Type::getInt8PtrTy(C), NULL};
			Type* arrFuncString[3] = {Type::getInt8PtrTy(C), Type::getInt32Ty(C), NULL};

			ArrayRef<Type*> arg1(arr1, 1);
			ArrayRef<Type*> arg3(arr3, 2);
			ArrayRef<Type*> arg5(arr5, 6);
			//ArrayRef<Type*> arg5(arr5, 7);
			ArrayRef<Type*> argFuncString(arrFuncString, 2);

			FunctionType* type1 = FunctionType::get(VoidTy, arg1, false);
			FunctionType* type2 = FunctionType::get(VoidTy, false);
			FunctionType* type3 = FunctionType::get(VoidTy, arg3, false);
			FunctionType* type5 = FunctionType::get(VoidTy, arg5, false);
			FunctionType* typeFuncString = FunctionType::get(VoidTy, argFuncString, false);

			hookFunc1 = M.getOrInsertFunction(AF[0], type1);
			hookFunc2 = M.getOrInsertFunction(AF[1], type2);
			hookFunc3 = M.getOrInsertFunction(AF[2], type3);
			hookFunc5 = M.getOrInsertFunction(AF[3], type5);
			hookFuncString = M.getOrInsertFunction(AF[4], typeFuncString);
	...
	struct instru_kernel_branch : public ModulePass{
		...
		virtual bool runOnModule(Module &M)
		{
			...
			Type* arr3[3] = {Type::getInt32Ty(C), Type::getInt32Ty(C), NULL};
			Type* arrFuncString[3] = {Type::getInt8PtrTy(C), Type::getInt32Ty(C), NULL};
			Type* arrBB[6] = {Type::getInt32Ty(C), Type::getInt32Ty(C), Type::getInt32Ty(C), Type::getInt32Ty(C), Type::getInt8PtrTy(C), NULL};

			ArrayRef<Type*> arg1(arr1, 1);
			ArrayRef<Type*> arg3(arr3, 2);
			ArrayRef<Type*> argFuncString(arrFuncString, 2);
			ArrayRef<Type*> argBB(arrBB, 5);

			FunctionType* type1 = FunctionType::get(VoidTy, arg1, false);
			FunctionType* type2 = FunctionType::get(VoidTy, false);
			FunctionType* type3 = FunctionType::get(VoidTy, arg3, false);
			FunctionType* typeFuncString = FunctionType::get(VoidTy, argFuncString, false);
			FunctionType* typeBB = FunctionType::get(VoidTy, argBB, false);

			hookFunc1 = M.getOrInsertFunction(AF[0], type1);
			hookFunc2 = M.getOrInsertFunction(AF[1], type2);
			hookFunc3 = M.getOrInsertFunction(AF[2], type3);
			hookFuncString = M.getOrInsertFunction(AF[4], typeFuncString);
			hookFuncBB = M.getOrInsertFunction("passBasicBlock", typeBB);
		...
		virtual bool runOnBasicBlock42(Function::iterator &BB, bool yeskernel)
		{
			...
			builder.CreateGlobalStringPtr(bb_name);
	...
	struct instru_kernel_callpath : public ModulePass{
		...
		virtual bool runOnModule(Module &M)
		{
			...
			Type* arrFuncString[3] = {Type::getInt8PtrTy(C), Type::getInt32Ty(C), NULL};
			Type* arrFCall[6] = {Type::getInt8PtrTy(C), Type::getInt8PtrTy(C), Type::getInt32Ty(C), Type::getInt32Ty(C), Type::getInt8PtrTy(C), NULL};

			ArrayRef<Type*> argFuncString(arrFuncString, 2);
			ArrayRef<Type*> argFCall(arrFCall, 5);
		...
		void copyFunction(Module &M, Function* F)
		{
			...
			CloneFunctionInto(fc, &(*F) , VMap, F->getSubprogram() != nullptr, Returns, "", codeinfo);
	...
	struct instru_host_sig : public ModulePass{
		...
		virtual bool runOnModule(Module &M)
		{
			...
			Type* arrTrace[3] = {Type::getInt8PtrTy(C), Type::getInt8PtrTy(C), NULL};
			Type* arrHandle[2] = {Type::getInt32Ty(C), NULL};
			Type* arrMalloc[2] = {Type::getInt64Ty(C), NULL};
			Type* arrFree[2] = {Type::getInt8PtrTy(C), NULL};
			Type* arrGridDims[4] = {Type::getInt32Ty(C), Type::getInt32Ty(C), Type::getInt32Ty(C), NULL};

			ArrayRef<Type*> argTrace(arrTrace, 2);
			ArrayRef<Type*> argHandle(arrHandle, 1);
			ArrayRef<Type*> argMalloc(arrMalloc, 1);
			ArrayRef<Type*> argFree(arrFree, 1);
			ArrayRef<Type*> argGridDims(arrGridDims, 3);

			FunctionType* typeSync = FunctionType::get(Type::getInt32Ty(C), false);
			FunctionType* typeTrace = FunctionType::get(VoidTy, argTrace, false);
			FunctionType* typeHandle = FunctionType::get(Type::getInt8PtrTy(C), argHandle, false);
			FunctionType* typeMalloc = FunctionType::get(Type::getInt8PtrTy(C), argMalloc, false);
			FunctionType* typeFree = FunctionType::get(VoidTy, argFree, false);
			FunctionType* typeGridDims = FunctionType::get(VoidTy, argGridDims, false);
			FunctionType* typeGridReset = FunctionType::get(VoidTy, false);
			FunctionType* typeGridGet = FunctionType::get(Type::getInt64Ty(C), false);

			M.getOrInsertFunction("cudaDeviceSynchronize", typeSync);
			M.getOrInsertFunction("appendTrace", typeTrace);
			M.getOrInsertFunction("getHandle", typeHandle);
			M.getOrInsertFunction("malloc", typeMalloc);
			M.getOrInsertFunction("free", typeFree);
			hookFuncGridDims = M.getOrInsertFunction("gridDims", typeGridDims);
			hookFuncGridReset = M.getOrInsertFunction("gridReset", typeGridReset);
			hookFuncGridGet = M.getOrInsertFunction("gridGet", typeGridGet);
			...
			{	//round 1
				...
				CloneFunctionInto(fc, &(*F) , VMap, F->getSubprogram() != nullptr, Returns, "", codeinfo); //TODO
			...
			if (bbname.find("entry") != std::string::npos )
			{
				...
				{ 
					...
					if (instcnt == 1)
					{
						...
						ai = builder.CreateAlloca( Type::getInt8PtrTy(C) , (Value*)NULL, "ptrhead.addr");
		...
		virtual bool runOnBasicBlock73(Function::iterator &BB)
		{
			...
			for(BasicBlock::iterator BI = BB->begin(), BE = BB->end(); BI != BE; ++BI)
			{
				...
				if ( auto *op = dyn_cast<CallInst>(BI) )
				{
					...
					builder.CreateCall(hookGridGet, {} );
					...
					buffer_d = builder.CreateAlloca( Type::getInt8PtrTy(C), (Value*)NULL /*, ptrhead*/);
					//Value* ptr2 = builder.CreateCall( fcudamalloc, { buffer_d, builder.getInt64(BUFFERSIZE)} );

					Function* fcudamalloc = BI->getModule()->getFunction("cudaMallocManaged");
					if (fcudamalloc == NULL) {
						Type* arrMallocManaged[4] = {buffer_d->getType(), Type::getInt64Ty(C), Type::getInt32Ty(C), NULL};
						ArrayRef<Type*> argMallocManaged(arrMallocManaged, 3);
						FunctionType* typeMallocManaged = FunctionType::get(Type::getInt32Ty(C), argMallocManaged, false);
						op->getModule()->getOrInsertFunction("cudaMallocManaged", typeMallocManaged);
						fcudamalloc = BI->getModule()->getFunction("cudaMallocManaged");
					}
					assert( fcudamalloc && "cudaMalloc() not exists!!\n");

					for (auto& arg : fcudamalloc->args()) {
						Type* ty = arg.getType();
						errs() << ty->getTypeID();
						if (IntegerType* ity = dyn_cast<IntegerType>(ty)) {
							errs() << " (" << ity->getBitWidth()/8 << ")" << "\n";
							continue;
						}
					...
					builder.CreateCall( fcudamalloc, { buffer_d, builder.getInt64(BUFFERSIZE), builder.getInt32(1)} );
					...
					builder.CreateCall(fAppendTrace, {p2trace, li_d});
	...
	struct instru_kernel_basic : public ModulePass{
		...
		virtual bool runOnModule(Module &M)
		{
			...
			Type* arrFuncRet[2] = {Type::getInt8PtrTy(C), NULL};
			Type* arrFuncInit[2] = {Type::getInt8PtrTy(C), NULL};

			ArrayRef<Type*> argFuncRet(arrFuncRet, 1);
			ArrayRef<Type*> argFuncInit(arrFuncInit, 1);

			FunctionType* typeFuncRet = FunctionType::get(VoidTy, argFuncRet, false);
			FunctionType* typeFuncInit = FunctionType::get(Type::getInt8PtrTy(C), argFuncInit, false);

			hookFuncRet = M.getOrInsertFunction(AF[5], typeFuncRet);
			hookFuncInit = M.getOrInsertFunction("InitKernel", typeFuncInit);
		...
		virtual bool runOnBasicBlock82(Function::iterator &BB)
		{
			...
			if (yeskernel && bb_name == "entry" ) //insert intialization into Kernel's entry block
			{
				...
				if (arg1->getType()->isPointerTy()) {
					if (!cast<PointerType>(arg1->getType())->getElementType()->isIntegerTy())
						arg1 = builder.CreatePointerCast(arg1, Type::getInt8PtrTy(C));
				}
				CallInst* tmpI = builder.CreateCall(hookInit, {arg1});
				//Value* print5_cnt = builder.createAlloca(Type::getInt32Ty(C));
	...
	struct instru_host_measure : public ModulePass{
		...
		virtual bool runOnModule(Module &M)
		{
			...
			Type* arrMeasure[2] = {Type::getInt32Ty(C), NULL};

			ArrayRef<Type*> argMeasure(arrMeasure, 1);

			FunctionType* typeSync = FunctionType::get(Type::getInt32Ty(C), false);
			FunctionType* typeMeasure = FunctionType::get(VoidTy, argMeasure, false);

			M.getOrInsertFunction("cudaDeviceSynchronize", typeSync);
			M.getOrInsertFunction("measureKernel", typeMeasure);
